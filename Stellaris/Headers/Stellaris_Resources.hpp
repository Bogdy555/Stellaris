...
#define STELLARIS_WND_CLASS_NAME AURORA_CORE_STRING_PREFIX("StellarisWndClass")
...
#define STELLARIS_IDS_DEFAULT_VERTEX_SHADER 1

#define STELLARIS_IDS_DEFAULT_FRAGMENT_SHADER 2
