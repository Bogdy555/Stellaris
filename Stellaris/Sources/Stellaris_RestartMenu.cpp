...
Stellaris::RunTime::RestartMenu::RestartMenu() : AuroraCore::RunTime::Menu(), Keys(), ControllerStates(), HighScore(0), Score(0)
{

}

Stellaris::RunTime::RestartMenu::~RestartMenu()
{

}

const uint64_t Stellaris::RunTime::RestartMenu::GetType() const
{
	return _RestartMenu;
}

void Stellaris::RunTime::RestartMenu::Setup()
{
	Application& _Application = *(Application*)(GetApplicationObj());

	Score = _Application.GetScore();
	HighScore = _Application.GetHighScore();

	if (Score > HighScore)
	{
		HighScore = Score;
		_Application.SetHighScore(Score);
	}
...
void Stellaris::RunTime::RestartMenu::Update()
{
...
void Stellaris::RunTime::RestartMenu::Stop()
{

}

void Stellaris::RunTime::RestartMenu::Input()
{
...
void Stellaris::RunTime::RestartMenu::DeleteInput()
{
	for (size_t _Index = 0; _Index < 256; _Index++)
	{
...
void Stellaris::RunTime::RestartMenu::Engine()
{
	Application* _ApplicationObj = (Application*)(GetApplicationObj());
...
void Stellaris::RunTime::RestartMenu::FrameBuild()
{
	Application& _Application = *(Application*)(GetApplicationObj());
